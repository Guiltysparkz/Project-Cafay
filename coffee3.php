...
$sql = "SELECT * FROM coffee WHERE productID = 3";
...
$result = $query->fetchAll(PDO::FETCH_ASSOC);
  ...
  <img id="product-image" src="<?= $product['productImage'] ?>" height="300px" width="300px"><img id="product-image" src="<?= $product['productAltImage'] ?>" height="300px" width="300px">
      ...
      <div class="product-info">
        <h1 class="product-title">La Roca [Pink Bourbon]</h1>
        <p>Colombie</p>
        <p class="product-description">Un bourbon rose Colombien aux notes subtiles et élégantes de cassis et d’agrumes, pour une tasse rafraîchissante.</p>
